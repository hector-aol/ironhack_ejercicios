...
Coches - por ejemplo, el número de identificación del vehículo (VIN), fabricante, modelo, año y color de los coches en el inventario de tu empresa.
Clientes - por ejemplo, la ID del cliente, nombre, número de teléfono, correo electrónico, dirección, ciudad, estado/provincia, país y código postal de los clientes.
Vendedores - por ejemplo, la ID del personal, nombre y la tienda de tu empresa.
Facturas - por ejemplo, el número de factura, fecha, coche, cliente y vendedor relacionado con cada venta de coche.
...
Crea una base de datos MySQL para este laboratorio. Puedes hacerlo en la línea de comandos de esta manera:
...
Ahora, basándote en el diseño de base de datos que creaste, escribe la consulta SQL para crear las tablas y columnas. Usarás la instrucción CREATE TABLE para la cual puedes encontrar referencia aquí.
...
Después de escribir y probar todas las instrucciones, crea un archivo de texto con el nombre create.sql. Al principio del archivo, indica qué base de datos quieres usar, por ejemplo:

USE lab_mysql;
Luego de la declaración USE, escribe todas tus sentencias CREATE TABLE. Necesitarás una declaración CREATE TABLE para cada tabla que decidas crear. Asegúrate de terminar cada declaración con un punto y coma.
...
Usarás la sentencia INSERT INTO para este propósito. Puedes referirte a un tutorial aquí.
...
Entrega
Al completar, añade los entregables a git, haz commit de los cambios, y envía a github. Asegúrate de enviar a tu propio repositorio bifurcado.

cd your-code
git add .
git commit -m "Soluciones de Lab MySQL"
git push origin master
Navega a tu repositorio bifurcado y crea una Solicitud de Extracción al repositorio de la clase.
...
Crea una solicitud de extracción con un título siguiendo este formato: [<lab_name>] <your_name>
...
¡Si has creado la solicitud de extracción con éxito, has terminado! FELICIDADES :)

References
Database seeding
MySQL Reference: Creating a Table
MySQL Reference: INSERT Syntax
MySQL Reference: UPDATE Syntax
MySQL Reference: DELETE Syntax